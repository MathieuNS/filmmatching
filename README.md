...
# Remplir SECRET_KEY, DATABASE_URL, TMDB_API_KEY...
...
Le script `get_films.py` récupère les films et séries depuis l'API TMDB :

```bash
# Récupérer les films des 7 derniers jours
python backend/get_films.py --start-date 7d

# Récupérer tous les films depuis une date
python backend/get_films.py --start-date 1950-01-01
```
...
│   ├── get_films.py        # Script d'import TMDB
│   ├── get_genres.py       # Script d'import des genres
│   ├── Dockerfile
│   └── requirement.txt
